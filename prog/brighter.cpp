...
//template<>
//HALIDE_ALWAYS_INLINE halide_type_t halide_type_of<test_int>() {
//    return halide_type_t(halide_type_test_int, 32);
//}
...
test_int_t<uint32_t> brighter(struct halide_buffer_t *);
...
test_int_t<uint32_t> brighter(struct halide_buffer_t *_brighter_buffer) HALIDE_FUNCTION_ATTRS {
 void * const _ucon = nullptr;
 test_int_t<uint64_t> _0 = (test_int_t<uint64_t>)(_input_buffer);
 test_int_t<uint64_t> _1 = (test_int_t<uint64_t>)(0);
 bool _2 = _0 != _1;
 if (!_2)  {
  test_int_t<uint32_t> _3 = halide_error_buffer_argument_is_null(_ucon, "input");
  return _3;
 }
 test_int_t<uint64_t> _4 = (test_int_t<uint64_t>)(_brighter_buffer);
 test_int_t<uint64_t> _5 = (test_int_t<uint64_t>)(0);
 bool _6 = _4 != _5;
 if (!_6)  {
  test_int_t<uint32_t> _7 = halide_error_buffer_argument_is_null(_ucon, "brighter");
  return _7;
 }
 void *_8 = _halide_buffer_get_host(_brighter_buffer);
 void * _brighter = _8;
 test_int_t<uint8_t> _9 = _halide_buffer_get_type_code(_brighter_buffer);
 test_int_t<uint8_t> _10 = _halide_buffer_get_type_bits(_brighter_buffer);
 test_int_t<uint16_t> _11 = _halide_buffer_get_type_lanes(_brighter_buffer);
 test_int_t<uint32_t> _12 = _halide_buffer_get_min(_brighter_buffer, 0);
 test_int_t<uint32_t> _13 = _halide_buffer_get_extent(_brighter_buffer, 0);
 test_int_t<uint32_t> _14 = _halide_buffer_get_stride(_brighter_buffer, 0);
 void *_15 = _halide_buffer_get_host(_input_buffer);
 void * _input = _15;
 test_int_t<uint8_t> _16 = _halide_buffer_get_type_code(_input_buffer);
 test_int_t<uint8_t> _17 = _halide_buffer_get_type_bits(_input_buffer);
 test_int_t<uint16_t> _18 = _halide_buffer_get_type_lanes(_input_buffer);
 test_int_t<uint32_t> _19 = _halide_buffer_get_min(_input_buffer, 0);
 test_int_t<uint32_t> _20 = _halide_buffer_get_extent(_input_buffer, 0);
 test_int_t<uint32_t> _21 = _halide_buffer_get_stride(_input_buffer, 0);
 bool _22 = _halide_buffer_is_bounds_query(_input_buffer);
 bool _23 = !(_22);
 bool _24 = 0 <= _12;
 test_int_t<uint32_t> _25 = _12 + _13;
 bool _26 = _25 <= 10;
 bool _27 = _24 && _26;
 bool _28 = _23 || _27;
 if (!_28)  {
  test_int_t<uint32_t> _29 = _12 + _13;
  test_int_t<uint32_t> _30 = _29 + -1;
  test_int_t<uint32_t> _31 = halide_error_constraints_make_required_region_smaller(_ucon, "Input buffer input", 0, 0, 9, _12, _30);
  return _31;
 }
 ...
 if (_32)
 {
  ...
  test_int_t<uint64_t> _34 = (test_int_t<uint64_t>)(0);
  void *_35 = (void *)(_34);
  struct halide_device_interface_t *_36 = (struct halide_device_interface_t *)(_34);
  struct {
   const test_int_t<uint32_t> f_0;
   const test_int_t<uint32_t> f_1;
   const test_int_t<uint32_t> f_2;
   const test_int_t<uint32_t> f_3;
  } s0 = {
   _12,
   _13,
   1,
  ...
  struct halide_dimension_t *_37 = (struct halide_dimension_t *)(&s0);
  struct halide_buffer_t *_38 = _halide_buffer_init(_brighter_buffer, _33, _35, _34, _36, 0, 64, 1, _37, _34);
  (void)_38;
 } // if _32
 ...
 if (_39)
 {
  ...
  test_int_t<uint64_t> _41 = (test_int_t<uint64_t>)(0);
  void *_42 = (void *)(_41);
  ...
  struct halide_dimension_t *_44 = (struct halide_dimension_t *)(&s1);
  struct halide_buffer_t *_45 = _halide_buffer_init(_input_buffer, _40, _42, _41, _43, 0, 64, 1, _44, _41);
  (void)_45;
 } // if _39
 bool _46 = _halide_buffer_is_bounds_query(_brighter_buffer);
 bool _47 = _halide_buffer_is_bounds_query(_input_buffer);
 bool _48 = _46 || _47;
 bool _49 = !(_48);
 if (_49)
 {
  test_int_t<uint8_t> _50 = (test_int_t<uint8_t>)(0);
  bool _51 = _9 == _50;
  test_int_t<uint8_t> _52 = (test_int_t<uint8_t>)(64);
  bool _53 = _10 == _52;
  bool _54 = _51 && _53;
  test_int_t<uint16_t> _55 = (test_int_t<uint16_t>)(1);
  bool _56 = _11 == _55;
  bool _57 = _54 && _56;
  if (!_57)   {
   test_int_t<uint8_t> _58 = (test_int_t<uint8_t>)(0);
   test_int_t<uint8_t> _59 = (test_int_t<uint8_t>)(64);
   test_int_t<uint16_t> _60 = (test_int_t<uint16_t>)(1);
   test_int_t<uint32_t> _61 = halide_error_bad_type(_ucon, "Output buffer brighter", _9, _58, _10, _59, _11, _60);
   return _61;
  }
  test_int_t<uint8_t> _62 = (test_int_t<uint8_t>)(0);
  bool _63 = _16 == _62;
  test_int_t<uint8_t> _64 = (test_int_t<uint8_t>)(64);
  bool _65 = _17 == _64;
  bool _66 = _63 && _65;
  test_int_t<uint16_t> _67 = (test_int_t<uint16_t>)(1);
  bool _68 = _18 == _67;
  bool _69 = _66 && _68;
  if (!_69)   {
   test_int_t<uint8_t> _70 = (test_int_t<uint8_t>)(0);
   test_int_t<uint8_t> _71 = (test_int_t<uint8_t>)(64);
   test_int_t<uint16_t> _72 = (test_int_t<uint16_t>)(1);
   test_int_t<uint32_t> _73 = halide_error_bad_type(_ucon, "Input buffer input", _16, _70, _17, _71, _18, _72);
   return _73;
  }
  bool _74 = 0 <= _13;
  if (!_74)   {
   test_int_t<uint32_t> _75 = halide_error_buffer_extents_negative(_ucon, "Output buffer brighter", 0, _13);
   return _75;
  }
  bool _76 = _19 <= _12;
  test_int_t<uint32_t> _77 = _12 + _13;
  test_int_t<uint32_t> _78 = _77 - _20;
  bool _79 = _78 <= _19;
  bool _80 = _76 && _79;
  if (!_80)   {
   test_int_t<uint32_t> _81 = _12 + _13;
   test_int_t<uint32_t> _82 = _81 + -1;
   test_int_t<uint32_t> _83 = _19 + _20;
   test_int_t<uint32_t> _84 = _83 + -1;
   test_int_t<uint32_t> _85 = halide_error_access_out_of_bounds(_ucon, "Input buffer input", 0, _12, _82, _19, _84);
   return _85;
  }
  bool _86 = 0 <= _20;
  if (!_86)   {
   test_int_t<uint32_t> _87 = halide_error_buffer_extents_negative(_ucon, "Input buffer input", 0, _20);
   return _87;
  }
  bool _88 = _14 == 1;
  if (!_88)   {
   test_int_t<uint32_t> _89 = halide_error_constraint_violated(_ucon, "brighter.stride.0", _14, "1", 1);
   return _89;
  }
  bool _90 = _21 == 1;
  if (!_90)   {
   test_int_t<uint32_t> _91 = halide_error_constraint_violated(_ucon, "input.stride.0", _21, "1", 1);
   return _91;
  }
  bool _92 = _19 == 0;
  if (!_92)   {
   test_int_t<uint32_t> _93 = halide_error_constraint_violated(_ucon, "input.min.0", _19, "0", 0);
   return _93;
  }
  bool _94 = _20 == 10;
  if (!_94)   {
   test_int_t<uint32_t> _95 = halide_error_constraint_violated(_ucon, "input.extent.0", _20, "10", 10);
   return _95;
  }
  test_int_t<uint64_t> _96 = (test_int_t<uint64_t>)(_13);
  test_int_t<uint64_t> _97 = (test_int_t<uint64_t>)(0);
  test_int_t<uint64_t> _98 = _97 - _96;
  bool _99 = _96 > _97;
  test_int_t<uint64_t> _100 = (test_int_t<uint64_t>)(_99 ? _96 : _98);
  test_int_t<uint64_t> _101 = (test_int_t<uint64_t>)(_100);
  test_int_t<uint64_t> _102 = _101;
  test_int_t<uint64_t> _103 = (test_int_t<uint64_t>)(2147483647);
  bool _104 = _102 <= _103;
  if (!_104)   {
   test_int_t<uint64_t> _105 = (test_int_t<uint64_t>)(_13);
   test_int_t<uint64_t> _106 = (test_int_t<uint64_t>)(0);
   test_int_t<uint64_t> _107 = _106 - _105;
   bool _108 = _105 > _106;
   test_int_t<uint64_t> _109 = (test_int_t<uint64_t>)(_108 ? _105 : _107);
   test_int_t<uint64_t> _110 = (test_int_t<uint64_t>)(_109);
   test_int_t<uint64_t> _111 = _110;
   test_int_t<uint64_t> _112 = (test_int_t<uint64_t>)(2147483647);
   test_int_t<uint32_t> _113 = halide_error_buffer_allocation_too_large(_ucon, "brighter", _111, _112);
   return _113;
  }
  test_int_t<uint64_t> _114 = (test_int_t<uint64_t>)(0);
  void *_115 = (void *)(_114);
  bool _116 = _brighter != _115;
  if (!_116)   {
   test_int_t<uint32_t> _117 = halide_error_host_is_null(_ucon, "Output buffer brighter");
   return _117;
  }
  test_int_t<uint64_t> _118 = (test_int_t<uint64_t>)(0);
  void *_119 = (void *)(_118);
  bool _120 = _input != _119;
  if (!_120)   {
   test_int_t<uint32_t> _121 = halide_error_host_is_null(_ucon, "Input buffer input");
   return _121;
  }
  // produce brighter
  for (int _brighter_s0_x = _12; _brighter_s0_x < _12 + _13; _brighter_s0_x++)
  {
   test_int_t<uint64_t> _122 = ((const test_int_t<uint64_t> *)_input)[_brighter_s0_x];
   test_int_t<uint64_t> _123 = (test_int_t<uint64_t>)(1);
   test_int_t<uint64_t> _124 = _122 + _123;
   test_int_t<uint32_t> _125 = _brighter_s0_x - _12;
   ((test_int_t<uint64_t> *)_brighter)[_125] = _124;
  } // for _brighter_s0_x
 } // if _49
 return 0;
}
test_int_t<uint32_t> brighter_old_buffer_t(struct buffer_t *_brighter) HALIDE_FUNCTION_ATTRS {
 void * const _ucon = nullptr;
 struct {
  const test_int_t<uint32_t> f_0;
  const test_int_t<uint32_t> f_1;
 ...
 struct halide_dimension_t *_126 = (struct halide_dimension_t *)(&s2);
 struct halide_dimension_t * _t12 = _126;
 halide_buffer_t b0;
 struct halide_buffer_t *_127 = &b0;
 test_int_t<uint64_t> _128 = (test_int_t<uint64_t>)(0);
 void *_129 = (void *)(_128);
 ...
 test_int_t<uint32_t> _132 = halide_upgrade_buffer_t(_ucon, "brighter", _brighter, _brighter_upgraded);
 bool _133 = _132 == 0;
 if (!_133)  {
  return _132;
 }
 test_int_t<uint32_t> _134 = brighter(_brighter_upgraded);
 bool _135 = _134 == 0;
 if (!_135)  {
  return _134;
 }
 ...
 if (_136)
 {
  test_int_t<uint32_t> _137 = halide_downgrade_buffer_t(_ucon, "brighter", _brighter_upgraded, _brighter);
  bool _138 = _137 == 0;
  if (!_138)   {
   return _137;
  }
 ...
 {
  test_int_t<uint32_t> _139 = halide_downgrade_buffer_t_device_fields(_ucon, "brighter", _brighter_upgraded, _brighter);
  bool _140 = _139 == 0;
  if (!_140)   {
   return _139;
  }
